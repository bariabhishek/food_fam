...
class AppTextStyle {
  ...
  static const String _regular = "assets/fonts/roboto/Roboto-Regular.ttf";
  ...
  final TextStyle normalStyle1;
  final TextStyle normalStyle2;
  ...
  AppTextStyle.getStyle()
      : screenTitle = new TextStyle(
        ...
        normalStyle1 = new TextStyle(
          fontFamily: _regular,
          fontSize: AppFontSize.s16,
          color: Colors.white,
          inherit: true,
        ),
        normalStyle2 = new TextStyle(
          fontFamily: _regular,

...
class _OrderDetailsPicState extends State<OrderDetailsPic> {
  ...
  void initState() {
    ...
    widget.orderDetails.forEach((element) { grandTotel=grandTotel+ int.parse(element.orderPrice);});
    setState(() {
          ...
          Text('Totel Items ( '+widget.orderDetails.length.toString()+" )",style: AppTheme.textStyle.lightHeading.copyWith(
            ...
            Expanded(
              ...
              itemBuilder: (context,int index){
                return orderList(widget.orderDetails[index].orderName,
                    widget.orderDetails[index].orderPrice,
                    widget.orderDetails[index].orderQuantity);
              },),
            ),
            SizedBox(height: SizeConfig.heightMultiplier*2,),
  ...
  Widget orderList(String orderName, String orderPrice, String orderQuantity) {
